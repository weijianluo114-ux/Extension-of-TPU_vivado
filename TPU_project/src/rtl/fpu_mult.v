...
// All rights reserved     
// File name:              
// Last modified Date:     2026/05/10 21:09:02
// Last Version:           V1.0
// Descriptions:           
//----------------------------------------------------------------------------------------
// Created by:             Please Write You Name 
// Created date:           2026/05/10 21:09:02
// mail      :             Please Write mail 
// Version:                V1.0
// TEXT NAME:              fpu_mult.v
// PATH:                   E:\electronic2\project\verilog_pro\TPU_vivado\TPU_project\src\rtl\fpu_mult.v
// Descriptions:           
//                         
//----------------------------------------------------------------------------------------
//****************************************************************************************//
    ...
    always @(*) begin
        if (one_m_reg == 0 && !zero_times_inf_stage2) begin
            ...
            if (round_cfg) begin
                ...
                if (mul_out_p[MANT_WIDTH] && (mul_out_p[MANT_WIDTH-1] || |mul_out_p[MANT_WIDTH-2:0])) two_m_out = mul_out_p[2*(MANT_WIDTH+1)-3:MANT_WIDTH] + 1;  // 向上舍入
