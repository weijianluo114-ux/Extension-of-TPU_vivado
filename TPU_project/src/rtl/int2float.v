...
// All rights reserved     
// File name:              
// Last modified Date:     2026/05/10 21:09:22
// Last Version:           V1.0
// Descriptions:           
//----------------------------------------------------------------------------------------
// Created by:             Please Write You Name 
// Created date:           2026/05/10 21:09:22
// mail      :             Please Write mail 
// Version:                V1.0
// TEXT NAME:              int2float.v
// PATH:                   E:\electronic2\project\verilog_pro\TPU_vivado\TPU_project\src\rtl\int2float.v
// Descriptions:           
//                         
//----------------------------------------------------------------------------------------
//****************************************************************************************//
...
module int2float (
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (pre_valid) begin
                ...
                end else if (mode && r_int_in == 0) begin
                    stage0_valid <= pre_valid;
                    stage0_if_input_0 <= 1;
                end else begin
                    stage0_valid  <= pre_valid;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            end else if (mode && stage0_if_input_0) begin
                stage1_if_input_0 <= stage0_if_input_0;
            end else begin
                stage1_valid  <= stage0_valid;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            end else if (mode && stage1_if_input_0) begin
                stage2_if_input_0 <= stage1_if_input_0;
            end else if (!mode && stage1_valid) begin
                stage2_valid  <= stage1_valid;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (stage2_valid) begin
                ...
                end else if (mode && stage2_if_input_0) begin
                    out_valid <= 1'b1;
                    float_out <= 'd0;
                end else begin
                    out_valid <= 1'b1;
