...
// All rights reserved     
// File name:              
// Last modified Date:     2026/05/10 21:09:41
// Last Version:           V1.0
// Descriptions:           
//----------------------------------------------------------------------------------------
// Created by:             Please Write You Name 
// Created date:           2026/05/10 21:09:41
// mail      :             Please Write mail 
// Version:                V1.0
// TEXT NAME:              matmult_kernel.sv
// PATH:                   E:\electronic2\project\verilog_pro\TPU_vivado\TPU_project\src\rtl\matmult_kernel.sv
// Descriptions:           
//                         
//----------------------------------------------------------------------------------------
//****************************************************************************************//
...
module matmult_kernel #(
    ...
    generate
        for (i = 0; i < 16; i = i + 1) begin : fpu_mult_stage_1
            fpu_mult_32 fpu_mult_stage_1_inst (
                .clk              (clk),
                .en               (fp_en),
                .rst_n            (rst_n),
                .round_cfg        (1'b1),
